...
# Install MyCV-GPU-Server API as System Service
...
print_status "🔧 Installing MyCV-GPU-Server API as System Service..."
...
print_success "✅ MyCV-GPU-Server API Service installed successfully!"
echo ""
