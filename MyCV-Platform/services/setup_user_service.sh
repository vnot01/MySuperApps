...
# Setup MyCV-GPU-Server API as User Systemd Service
...
print_status "🔧 Setting up MyCV-GPU-Server API as User Systemd Service..."
...
[Unit]
Description=MyCV-GPU-Server API Service
...
SyslogIdentifier=mycv-gpu-server
...
print_success "✅ MyCV-GPU-Server API User Service installed successfully!"
echo ""
