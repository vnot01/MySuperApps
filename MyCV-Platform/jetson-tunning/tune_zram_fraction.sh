...
echo "[1/6] Write systemd zram generator config (2x RAM, cap 16G, zstd, prio 150)"
...
echo "[2/6] Stop zram service and detach old device"
...
echo "[3/6] Reload systemd and start zram service"
sudo systemctl daemon-reload
sudo systemctl start systemd-zram-setup@zram0.service

echo "[4/6] Ensure NVMe /swapfile active with priority 60"
